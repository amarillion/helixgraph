...
export class PriorityQueue {
    ...
    _greater(i, j) {
        return __classPrivateFieldGet(this, _PriorityQueue_comparator, "f").call(this, __classPrivateFieldGet(this, _PriorityQueue_heap, "f")[i], __classPrivateFieldGet(this, _PriorityQueue_heap, "f")[j]);
    }
    _swap(i, j) {
